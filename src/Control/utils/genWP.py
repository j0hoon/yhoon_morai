...
DISTANCE_WP2WP_STRAIGHT=2.5 # init=50
DISTANCE_WP2WP_CURVE=0.45 # init=5
plot_switch=0

load_data=np.loadtxt('km_path_3.csv',delimiter=',',dtype=str) # Input GPS csv file
...
if (plot_switch==1):
    ...
    plt.scatter(WP_X,WP_Y,s=10,c='black')
    plt.grid()
    plt.show()
