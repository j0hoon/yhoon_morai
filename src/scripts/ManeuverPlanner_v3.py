...
class ManeuverPlanner():
    def __init__(self):
        ...
        self.sub_mission = rospy.Subscriber('/mission', Mission, self.callback_mission)
        ...
        # self.sub_Object = rospy.Subscriber('/vision_bbox', bboxes_3d, self.callback_object)
        self.FrameRate = 20
    ...
    def main(self):
        ...
        while not rospy.is_shutdown():
            ...
            maneuver_mode                                   = self.ManeuverMode(risk, object_state, trafficlight_signal,self.Mission_status)
            ...
            print('object status : ',object_state,'mission : ',self.Mission_status)
